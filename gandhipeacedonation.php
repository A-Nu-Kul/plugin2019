...
spl_autoload_register('GandhipeaceDonation::autoload');

/**
 * Init Singleton Class for Gandhipeace Donation.
 *
...
class GandhipeaceDonation
{
    ...
    const OPTION_DB_KEY    = 'gandhipeace-donations_options';
    const TEXT_DOMAIN      = 'gandhipeace-donations';
    const FILE             = __FILE__;
    ...
    private function __construct()
    {
        ...
        $admin = new GandhipeaceDonation_Admin();
        $admin->setOptions(
        ...
        add_shortcode('gandhipeace-donation', array(&$this,'paypalShortcode'));
    ...
    public function handle_widgets_init(){
        register_widget("GandhipeaceDonation_Widget");
    }
    ...
    {
        delete_option('gandhipeace_donation_options');
        delete_option('widget_gandhipeace_donation');
    }
    ...
    public function addCss()
    {
        ...
        if (isset($opts['center_button']) and $opts['center_button'] == true) {
            ...
            echo '.gandhipeace-donation { text-align: center !important }'."\n";
            echo '</style>'."\n";
        }
    }
    ...
    public function generateHtml(
        ...
        return GandhipeaceDonation_View::render('paypal-button', $data);
    }
...
add_action('plugins_loaded', array('GandhipeaceDonation', 'getInstance'));
