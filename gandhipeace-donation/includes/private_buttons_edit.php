			...
			<form method='post' action='<?php $_SERVER["REQUEST_URI"]; ?>'>
				...
				<div style="background-color:#fff;padding:8px;border: 1px solid #CCCCCC;"><br />
					...
					<table><tr><td>
						...
						Shortcode: </td><td><input type="text" readonly="true" value="<?php echo "[wpedon id=$post_id]"; ?>"></td><td>Put this in a page, post, PayPal widget, or <a target="_blank" href="http://anukuls.sgedu.site/">in your theme</a>, to show the PayPal button on your site. <br />You can also use the button inserter found above the page or post editor.</td></tr><tr><td>
