...
add_action('init', 'gandhipeace_donation_ipn_listener');

function gandhipeace_donation_ipn_listener(){
    //Listen for IPN and validate it
    if (isset($_REQUEST['gpd_paypal_ipn']) && $_REQUEST['gpd_paypal_ipn'] == "process") {
        gandhipeace_donation_validate_paypl_ipn();
        exit;
    }
}

function gandhipeace_donation_validate_paypl_ipn() {
    ...
    $params = array(
        ...
        'compress'	 => false,
        'decompress'	 => false,
        'user-agent'	 => 'Gandhipeace Donation Plugin/TTHQ'
    );
