 ...
 *
 * @version		1.0.0
 * @package		Gandhipeacedonation/Classes/Gandhipeacedonation_Gateway
...
if ( ! class_exists( 'Gandhipeacedonation_Gateway' ) ) :

	/**
	 * Gandhipeacedonation_Gateway
	 *
	 * @abstract
	 * @since   1.0.0
	 */
	abstract class Gandhipeacedonation_Gateway implements Gandhipeacedonation_Gateway_Interface {
		...
		public function default_gateway_settings() {
			return array(
				...
				'label' => array(
					'type'      => 'text',
					'title'     => __( 'Gateway Label', 'gandhipeacedonation' ),
					'help'      => __( 'The label that will be shown to donors on the donation form.', 'gandhipeacedonation' ),
					'priority'  => 4,
		...
		public function get_settings() {
			return gandhipeacedonation_get_option( 'gateways_' . $this->get_gateway_id(), array() );
		}
		...
		public function get_label() {
			return gandhipeacedonation_get_option( 'label', $this->get_default_label(), $this->get_settings() );
		}
		...
		public function get_value( $setting ) {
			...
			return gandhipeacedonation_get_option( $setting, $default, $this->get_settings() );
		}
		...
		public function supports( $feature ) {
			...
			return apply_filters( 'gandhipeacedonation_payment_gateway_supports', $supported, $feature, $this );
		}
		 ...
		 * @since  1.6.0
		 *
		 * @param  Gandhipeacedonation_Donation $donation The donation object.
		 * @return boolean
		 */
		public function is_donation_refundable( Gandhipeacedonation_Donation $donation ) {
		...
		public function get_credit_card_fields() {
			...
			return apply_filters(
				'gandhipeacedonation_credit_card_fields',
				array(
					'cc_name' => array(
						'label'     => __( 'Name on Card', 'gandhipeacedonation' ),
						'type'      => 'text',
						'required'  => true,
						'priority'  => 2,
						'data_type' => 'gateway',
					...
					'cc_number' => array(
						'label'     => __( 'Card Number', 'gandhipeacedonation' ),
						'type'      => 'text',
						'required'  => true,
						'priority'  => 4,
						'data_type' => 'gateway',
					...
					'cc_cvc' => array(
						'label'     => __( 'CVV Number', 'gandhipeacedonation' ),
						'type'      => 'text',
						'required'  => true,
						'priority'  => 6,
						'data_type' => 'gateway',
					...
					'cc_expiration' => array(
						'label'     => __( 'Expiration', 'gandhipeacedonation' ),
						'type'      => 'cc-expiration',
						'required'  => true,
						'priority'  => 8,
						'data_type' => 'gateway',
		...
		public static function redirect_to_processing( $result, $donation_id ) {
			return array(
				'safe'     => true,
				'redirect' => gandhipeacedonation_get_permalink( 'donation_processing_page', array(
		...
		public function requires_credit_card_form() {
			gandhipeacedonation_get_deprecated()->deprecated_function( __METHOD__, '1.3.0', 'Gandhipeacedonation_Gateway::supports( \'credit-card\' )' );
