<?php
/**
 * Base Gandhipeacedonation_Field model.
 *
 * @package   Gandhipeacedonation/Classes/Gandhipeacedonation_Field
...
if ( ! class_exists( 'Gandhipeacedonation_Field' ) ) :
	 ...
	 */
	abstract class Gandhipeacedonation_Field implements Gandhipeacedonation_Field_Interface {
		 ...
		 * @return Gandhipeacedonation_Field
		 */
		public function set( $key, $setting, $value ) {
			...
			if ( ! is_array( $arg ) ) {
				gandhipeacedonation_get_deprecated()->doing_it_wrong(
					...
					sprintf( _x( 'Attempting to set an argument setting for a non-array argument. Argument: %s', 'argument key', 'gandhipeacedonation' ), $key ),
					'1.6.0'
				);
