<?php
/**
 * Gandhipeacedonation DB base class.
 *
 ...
 *
 * @package   Gandhipeacedonation/Classes/Gandhipeacedonation_DB
...
if ( ! class_exists( 'Gandhipeacedonation_DB' ) ) :

	/**
	 * Gandhipeacedonation_DB
	 *
	 * @abstract
	 * @since  1.0.0
	 */
	abstract class Gandhipeacedonation_DB {
		...
		public function insert( $data, $type = '' ) {
			...
			do_action( 'gandhipeacedonation_post_insert_' . $type, $wpdb->insert_id, $data );
