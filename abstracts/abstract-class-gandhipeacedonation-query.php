<?php
/**
 * An abstract base class defining common methods used by Gandhipeacedonation queries.
 *
 * @package     Gandhipeacedonation/Classes/Gandhipeacedonation_Query
...
if ( ! class_exists( 'Gandhipeacedonation_Query' ) ) :

	/**
	 * Gandhipeacedonation_Query
	 *
	 * @since  1.0.0
	 */
	abstract class Gandhipeacedonation_Query implements Iterator {
		...
		public function set( $key, $value ) {
			$this->args[ $key ] = apply_filters( 'gandhipeacedonation_query_sanitize_argument_' . $key, $value, $this );
		}
		...
		public function get_query() {
			if ( ! isset( $this->query ) ) {
				 ...
				 * @since 1.0.0
				 *
				 * @param Gandhipeacedonation_Query The `Gandhipeacedonation_Query` instance.
				 */
				do_action( 'gandhipeacedonation_pre_query', $this );
				 ...
				 * @param Gandhipeacedonation_Query The `Gandhipeacedonation_Query` instance.
				 */
				do_action( 'gandhipeacedonation_post_query', $this );
		...
		public function get_found_items() {
			 ...
			 * @param Gandhipeacedonation_Query $query                 The `Gandhipeacedonation_Query` instance.
			 */
			$found_items_query = apply_filters( 'gandhipeacedonation_found_items_query', 'SELECT FOUND_ROWS()', $this );
		 ...
		 *
		 * This is used instead of Gandhipeacedonation_Query::fields and is only appropriate
		...
		public function select_count() {
			 ...
			 * @param Gandhipeacedonation_Query $query The `Gandhipeacedonation_Query` instance.
			 */
			return apply_filters( 'gandhipeacedonation_select_count_fields', "COUNT(DISTINCT {$wpdb->posts}.ID)", $this );
		}
		...
		public function fields() {
			 ...
			 * @param Gandhipeacedonation_Query $query The `Gandhipeacedonation_Query` instance.
			 */
			return apply_filters( 'gandhipeacedonation_query_fields', "$found_rows {$wpdb->posts}.ID", $this );
		}
		...
		public function from() {
			 ...
			 * @param Gandhipeacedonation_Query $query The `Gandhipeacedonation_Query` instance.
			 */
			return apply_filters( 'gandhipeacedonation_query_from', "FROM $wpdb->posts", $this );
		}
		...
		public function join() {
			 ...
			 * @param Gandhipeacedonation_Query $query The `Gandhipeacedonation_Query` instance.
			 */
			return apply_filters( 'gandhipeacedonation_query_join', '', $this );
		}
		...
		public function where() {
			 ...
			 * @param Gandhipeacedonation_Query $query This query object.
			 */
			return apply_filters( 'gandhipeacedonation_query_where', 'WHERE 1=1 ', $this );
		}
		...
		public function groupby() {
			 ...
			 * @param Gandhipeacedonation_Query $query This query object.
			 */
			return apply_filters( 'gandhipeacedonation_query_groupby', '', $this );
		}
		...
		public function orderby() {
			 ...
			 * @param Gandhipeacedonation_Query $query The `Gandhipeacedonation_Query` instance.
			 */
			return apply_filters( 'gandhipeacedonation_query_orderby', "ORDER BY {$wpdb->posts}.ID", $this );
		}
		...
		public function order() {
			 ...
			 * @param Gandhipeacedonation_Query $query The `Gandhipeacedonation_Query` instance.
			 */
			return apply_filters( 'gandhipeacedonation_query_order', $this->get( 'order', 'DESC' ), $this );
		}
		...
		public function limit() {
			 ...
			 * @param Gandhipeacedonation_Query $query The `Gandhipeacedonation_Query` instance.
			 */
			return apply_filters( 'gandhipeacedonation_query_limit', sprintf( 'LIMIT %d', $this->get( 'number', 20 ) ), $this );
		}
		...
		public function offset() {
			 ...
			 * @param Gandhipeacedonation_Query $query The `Gandhipeacedonation_Query` instance.
			 */
			return apply_filters( 'gandhipeacedonation_query_offset', sprintf( 'OFFSET %d', $offset ), $this );
		}
		...
		public function where_donation_plan_is_in( $where_statement ) {
			...
			$placeholders = $this->get_where_in_placeholders( $donation_plan, 'gandhipeacedonation_validate_absint', '%d' );
		...
		public function where_campaign_is_in( $where_statement ) {
			...
			$placeholders = $this->get_where_in_placeholders( $this->get( 'campaign', 0 ), 'gandhipeacedonation_validate_absint', '%d' );
		...
		public function where_status_is_in( $where_statement ) {
			...
			$placeholders = $this->get_where_in_placeholders( $status, 'gandhipeacedonation_is_valid_donation_status', '%s' );
		...
		public function where_donor_id_is_in( $where_statement ) {
			...
			$placeholders = $this->get_where_in_placeholders( $donor_id, 'gandhipeacedonation_validate_absint', '%d' );
		...
		public function where_user_id_is_in( $where_statement ) {
			...
			$placeholders = $this->get_where_in_placeholders( $user_id, 'gandhipeacedonation_validate_absint', '%d' );
		...
		public function join_campaign_donations_table_on_campaign( $join_statement ) {
			global $wpdb;
			return $join_statement . " INNER JOIN {$wpdb->prefix}gandhipeacedonation_campaign_donations cd ON cd.campaign_id = $wpdb->posts.ID ";
		}
		...
		public function join_campaign_donations_table_on_donation( $join_statement ) {
			global $wpdb;
			return $join_statement . " INNER JOIN {$wpdb->prefix}gandhipeacedonation_campaign_donations cd ON cd.donation_id = $wpdb->posts.ID ";
		}
		...
		public function join_donors_table( $join_statement ) {
			global $wpdb;
			return $join_statement . " INNER JOIN {$wpdb->prefix}gandhipeacedonation_donors d ON d.donor_id = cd.donor_id ";
		}
		...
		protected function get_placeholders( $count = 1, $placeholder = '%s' ) {
			return gandhipeacedonation_get_query_placeholders( $count, $placeholder );
		}
	}
