<?php
/**
 * Base Gandhipeacedonation_Field_Registry model.
 *
 * @package   	Gandhipeacedonation/Classes/Gandhipeacedonation_Field_Registry
 * @version 	1.0.0
...
if ( ! class_exists( 'Gandhipeacedonation_Field_Registry' ) ) :

	/**
	 * Gandhipeacedonation_Field
	 *
	 * @since 1.0.0
	 */
	abstract class Gandhipeacedonation_Field_Registry implements Gandhipeacedonation_Field_Registry_Interface {
		 ...
		 * @return Gandhipeacedonation_Field|false Instance of `Gandhipeacedonation_Field` if the field
		...
		public function order_fields() {
			foreach ( $this->forms as $key ) {
				$fields = array_filter( $this->fields, array( new Gandhipeacedonation_Field_Filter( $key ), 'is_not_false' ) );

				new Gandhipeacedonation_Field_Sorter( $fields, $this, $key );
			}
		}
		 ...
		 * @param  Gandhipeacedonation_Field $field    Instance of `Gandhipeacedonation_Field`.
		 * @return array
		 */
		protected function parse_form_settings( array $settings, Gandhipeacedonation_Field $field ) {
