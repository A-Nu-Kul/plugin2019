 ...
 *
 * @package   Gandhipeacedonation/Classes/Gandhipeacedonation_Endpoint
...
if ( ! class_exists( 'Gandhipeacedonation_Endpoint' ) ) :

	/**
	 * Gandhipeacedonation_Endpoint
	 *
	 * @abstract
	 * @since  1.0.0
	 */
	abstract class Gandhipeacedonation_Endpoint implements Gandhipeacedonation_Endpoint_Interface {
