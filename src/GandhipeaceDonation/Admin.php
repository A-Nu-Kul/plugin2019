 ...
 */
class GandhipeaceDonation_Admin
{
    ...
    const PAGE_SLUG = 'gandhipeace-donation-options';
    ...
    {
        $data = array(
            'pageSlug'    => GandhipeaceDonation_Admin::PAGE_SLUG,
            'optionDBKey' => GandhipeaceDonation::OPTION_DB_KEY,
        );
        echo GandhipeaceDonation_View::render('admin', $data);
    }
    ...
    {
        if ($hook != 'settings_page_gandhipeace-donation-options') {
            return;
        }
        $plugin = get_plugin_data(GandhipeaceDonation::FILE, false, false);
        $version = $plugin['Version'];

        wp_register_style(
            'gandhipeace-donation',
            plugins_url('assets/tabs.css', GandhipeaceDonation::FILE),
            array(),
            $version
        );
        wp_enqueue_style('gandhipeace-donation');

        wp_enqueue_script(
            'gandhipeace-donation',
            plugins_url('assets/tabs.js', GandhipeaceDonation::FILE),
            array('jquery'),
            $version,
            false
        );
    ...
    public function init()
    {
        add_settings_section(
            ...
            __('Account Setup', GandhipeaceDonation::TEXT_DOMAIN),
            array($this, 'accountSetupCallback'),
            self::PAGE_SLUG
        );
        add_settings_field(
            'paypal_account',
            __('PayPal Account', GandhipeaceDonation::TEXT_DOMAIN),
            ...
            array(
                ...
                'description' => __(
                    'Please Enter Your PayPal Email or Secure Merchant Account ID.',
        ...
        add_settings_field(
            'currency_code',
            __('Currency', GandhipeaceDonation::TEXT_DOMAIN),
            ...
            array(
                ...
                'description' => __(
                    'Please Enter the currency to use for the donations.',
                    GandhipeaceDonation::TEXT_DOMAIN
                ),
            )
        );
        ...
        add_settings_section(
            'optional_section',
            __('Optional Settings', GandhipeaceDonation::TEXT_DOMAIN),
            '',
            self::PAGE_SLUG
        );
        add_settings_field(
            'page_style',
            __('Page Style', GandhipeaceDonation::TEXT_DOMAIN),
        ...
        add_settings_field(
            'return_page',
            __('Return Page', GandhipeaceDonation::TEXT_DOMAIN),
        ...
        add_settings_section(
            'default_section',
            __('Defaults', GandhipeaceDonation::TEXT_DOMAIN),
            '',
            self::PAGE_SLUG
        );
        add_settings_field(
            'amount',
            __('Amount', GandhipeaceDonation::TEXT_DOMAIN),
        ...
        add_settings_field(
            'purpose',
            __('Purpose', GandhipeaceDonation::TEXT_DOMAIN),
        ...
        add_settings_field(
            'reference',
            __('Reference', GandhipeaceDonation::TEXT_DOMAIN),
        ...
        add_settings_section(
            ...
            __('Donation Button', GandhipeaceDonation::TEXT_DOMAIN),
            '',
            self::PAGE_SLUG
        );
        add_settings_field(
            'button',
            __('Select Button', GandhipeaceDonation::TEXT_DOMAIN),
        ...
        add_settings_field(
            'button_url',
            __('Custom Button', GandhipeaceDonation::TEXT_DOMAIN),
        ...
        add_settings_field(
            'button_localized',
            __('Country and Language', GandhipeaceDonation::TEXT_DOMAIN),
        ...
        add_settings_section(
            'extras_section',
            __('Extras', GandhipeaceDonation::TEXT_DOMAIN),
            array($this, 'extrasCallback'),
            self::PAGE_SLUG
        );
        add_settings_field(
            'disable_stats',
            __('Disable PayPal Statistics', GandhipeaceDonation::TEXT_DOMAIN),
        ...
        add_settings_field(
            'remove_lf',
            __('Remove Line Feeds', GandhipeaceDonation::TEXT_DOMAIN),
        ...
        add_settings_field(
            'sandbox',
            __('Enable PayPal Sandbox', GandhipeaceDonation::TEXT_DOMAIN),
            ...
            array(
                'label_for' => 'sandbox',
                'description' => sprintf(
                    __('Enable PayPal sandbox for testing. Visit %s for more information and to register a merchant and customer testing accounts.', GandhipeaceDonation::TEXT_DOMAIN),
        ...
        add_settings_field(
            ...
            __('Enable Checkout Language', GandhipeaceDonation::TEXT_DOMAIN),
        ...
        add_settings_field(
            'checkout_language',
            __('Checkout Language', GandhipeaceDonation::TEXT_DOMAIN),
        ...
        add_settings_field(
            'return_method',
            __('Return Method', GandhipeaceDonation::TEXT_DOMAIN),
        ...
        register_setting(
            GandhipeaceDonation::OPTION_DB_KEY,
            GandhipeaceDonation::OPTION_DB_KEY
        );
    }
    ...
    public function accountSetupCallback()
    {
        printf(
            '<p>%s</p>',
            __('Required fields.', GandhipeaceDonation::TEXT_DOMAIN)
        );
    }

    public function tabsCallback()
    {
        echo "</div><div id='gandhipeace-donation-tab-content-2'>";
    }
    ...
    {
        $optionKey = GandhipeaceDonation::OPTION_DB_KEY;
    ...
    public function buttonCallback($args)
    {
        ...
        checked($custom, true);
        echo '/> '.__('Custom Button', GandhipeaceDonation::TEXT_DOMAIN);
